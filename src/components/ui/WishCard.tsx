...
function Avatar({ name }: { name: string }) {
  ...
  return (
    <div
      aria-hidden="true"
      className="w-10 h-10 rounded-full bg-[#FBF7F1] flex items-center justify-center flex-shrink-0"
    >
...
export default function WishCard({ guestName, message, relationship, avatar }: WishCardProps) {
  return (
    <article className="flex flex-col p-8 bg-[#FBF7F1] hover:bg-[#FBF7F1] transition-colors duration-500 border border-[#B89558] h-full cursor-default">
      {/* Open quote */}
      <span
        className="font-serif leading-none text-[#B89558] mb-2 select-none"
      ...
      {/* Attribution */}
      <footer className="flex items-center gap-3 pt-5 border-t border-[#FBF7F1]">
