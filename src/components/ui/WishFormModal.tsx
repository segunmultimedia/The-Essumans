      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="w-full max-w-lg bg-[#FFFEF9] rounded-xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]"
            ...
            <div className="p-6 overflow-y-auto">
              {success ? (
                <div className="text-center py-10">
                  ...
                  <h4 className="text-xl font-serif text-[#1E1E1E] mb-3">Thank you!</h4>
                  <p className="text-[#6B6560]">Your wish has been submitted.</p>
                  <Button variant="primary" className="mt-8" onClick={onClose}>
                    Close
                  </Button>
                </div>
              ) : (
